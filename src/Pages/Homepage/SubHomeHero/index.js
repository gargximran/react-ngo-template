...
const SubHomeHero = () => {
    ...
    return (
        <section className={'grid grid-cols-1 md:grid-cols-2'}>
            <div className={'min-h-150px relative overflow-hidden flex items-center justify-center'}>
                <div className={'inline-block px-8 pb-10 pt-14 md:pb-0 md:pt-0'}>
                ...
                <img src={HomeHeroSideImage} className={'w-full absolute bottom-0 -z-1'} alt={'No Image!'}/>
            </div>
            <div>
                {/* eslint-disable-next-line*/}
